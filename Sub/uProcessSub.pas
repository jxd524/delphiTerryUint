...
interface
  ...
  function GetRunningProcessInfo(AList: TList): Integer;  //当前正在运行的进程信息: pProcessInfo
  function GetRunningProcessName(AList: TStringList): Integer; //当前正在运行的进行名称
  function IsProcessRun(const AFileName: string): Boolean; //AFileName: 全路径或文件名
