...
uses
  SysUtils, Classes, Controls, Graphics, JxdGradientPanel;

type
  TJxdCommonMode1 = class(TJxdGradientPanel)
  private
...
constructor TJxdCommonMode1.Create(AOwner: TComponent);
begin
  inherited;
  //变量初始化
  TopLineVisible := True;
...
destructor TJxdCommonMode1.Destroy;
begin

  inherited;
end;

procedure TJxdCommonMode1.DrawHorizontalLine(const ATopSpace, LineWidth: Integer; const ALineColor: TColor);
var
  X, X1, Y: Integer;
  OldColor: Tcolor;
  OldWidth: Integer;
...
procedure TJxdCommonMode1.DrawVerticalLine(const ALeftWidthSpace, LineWidth: Integer;
...
procedure TJxdCommonMode1.Paint;
begin
  inherited;
  if TopLineVisible then DrawHorizontalLine( TopHeight, TopLineWidth, TopLineColor );
  if BottomLineVisible then DrawHorizontalLine( Height - BottomHeight, BottomLineWidth, BottomLineColor );
  if LeftLineVisible then DrawVerticalLine( LeftWidth, LeftLineWidth, LeftLineColor );
  if RightLineVisible then DrawVerticalLine( Width - RightWidth, RightLineWidth, RightLineColor );
end;

procedure TJxdCommonMode1.SetBottomHeight(const Value: Integer);
begin
...
procedure TJxdCommonMode1.SetBottomLineColor(const Value: TColor);
begin
...
procedure TJxdCommonMode1.SetBottomLineVisible(const Value: Boolean);
begin
...
procedure TJxdCommonMode1.SetBottomLineWidth(const Value: Integer);
begin
...
procedure TJxdCommonMode1.SetLeftLineColor(const Value: TColor);
begin
...
procedure TJxdCommonMode1.SetLeftLineVisible(const Value: Boolean);
begin
...
procedure TJxdCommonMode1.SetLeftLineWidth(const Value: Integer);
begin
...
procedure TJxdCommonMode1.SetLeftWidth(const Value: Integer);
begin
...
procedure TJxdCommonMode1.SetRightLineColor(const Value: TColor);
begin
...
procedure TJxdCommonMode1.SetRightLineVisible(const Value: Boolean);
begin
...
procedure TJxdCommonMode1.SetRightLineWidth(const Value: Integer);
begin
...
procedure TJxdCommonMode1.SetRightWidth(const Value: Integer);
begin
...
procedure TJxdCommonMode1.SetTopHeight(const Value: Integer);
begin
...
procedure TJxdCommonMode1.SetTopLineColor(const Value: TColor);
begin
...
procedure TJxdCommonMode1.SetTopLineVisible(const Value: Boolean);
begin
...
procedure TJxdCommonMode1.SetTopLineWidth(const Value: Integer);
begin
