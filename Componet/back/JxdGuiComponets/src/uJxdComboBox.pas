...
uses
  SysUtils, Classes, Controls, StdCtrls, Messages, Windows, Graphics, uJxdGuiDef;
...
procedure TJxdComboBox.DrawScrollBitmap(const AState: Integer);
var
  X, Y: Integer;
  R: TRect;
  Bmp: TBitmap;
...
function TJxdComboBox.GetScroolBmpRect(const AState: Integer): TRect;
begin
  case AState of
...
procedure TJxdComboBox.SetScrollBitmapTransparent(const Value: Boolean);
begin
