...
interface
uses
  SysUtils, Classes, Windows, Controls, Types, ExtCtrls, Graphics, Messages, StdCtrls, uKKCustomButton;

type
  TKKCheckButton = class(TKKCustomButton)
  private
    FBoxOrgX: Integer;
    FBoxOrgY: Integer;
    FIsCheck: Boolean;
...
constructor TKKCheckButton.Create(AOwner: TComponent);
begin
  inherited;
  FBoxOrgX := 2;
  FBoxOrgY := 3;
...
procedure TKKCheckButton.DrawCustomButton(ABufBitmap: TBitmap; AMouseState: TKKControlState);
var
  R: TRect;
...
procedure TKKCheckButton.SetBackColor(const Value: TColor);
begin
...
procedure TKKCheckButton.SetBorderLineColor(const Value: TColor);
begin
...
procedure TKKCheckButton.SetBorderLineWide(const Value: Integer);
begin
...
procedure TKKCheckButton.SetBoxColor(const Value: TColor);
begin
...
procedure TKKCheckButton.SetBoxOrgX(const Value: Integer);
begin
...
procedure TKKCheckButton.SetBoxOrgY(const Value: Integer);
begin
...
procedure TKKCheckButton.SetChectk(const Value: Boolean);
begin
...
procedure TKKCheckButton.WMLButtonUp(var Message: TWMLButtonUp);
begin
