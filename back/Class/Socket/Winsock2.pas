...
//=======================================================================================================================
{Add by JiangXiaode at 2008-9-2}
{Winsock2 extensions -- function: AcceptEx}
const
  WSAID_ACCEPTEX: TGUID = '{B5367DF1-CBAC-11CF-95CA-00805F48A192}';
type
  lpnfAcceptEx = function(sListenSocket, sAcceptSocket: TSocket; lpOutputBuffer: Pointer; dwReceiveDataLength,
                           dwLocalAddressLength, dwRemoteAddressLength: DWORD; lpdwBytesReceived: PDWORD;
                           lpOverlapped: POverlapped): BOOL; stdcall;
  TAcceptEx = lpnfAcceptEx;

{Winsock2 extensions -- function: GetAcceptExSockaddrs}
const
...
type
  lpfnGetAcceptExSocketAddrs = procedure(lpOutputBuffer: Pointer; dwReceiveDataLength: DWORD;
    ...
    var LocalSockaddrLength: DWORD; var RemoteSockaddr: PSockAddr; var RemoteSockaddrLength: DWORD); stdcall;
  TGetAcceptExSockAddrs = lpfnGetAcceptExSocketAddrs;

{Winsock2 extensions -- function: ConnectEx}
const
...
{Winsock2 extensions -- function: DisconnectEx}
const
