...
uses
  ...
  SysUtils, Graphics, uJxdDrawSub, Forms, uJxdCustomScrollBar, ShellAPI;
...
type
  ...
  private
    ...
    FCellGradientDrawInfoEx: TGradientDrawInfo;
    ...
    procedure SetCellGradientDrawInfoEx(const Value: TGradientDrawInfo);
  ...
  published
    ...
    property CellGradientDrawInfoEx: TGradientDrawInfo read FCellGradientDrawInfoEx write SetCellGradientDrawInfoEx;
...
begin
  ...
  FFixedGradientDrawInfo.GradientNormalText := '#Gradient{fromColor: $F8D752; ColorTo: $E09406; percent: 100%}';
  ...
  FCellGradientDrawInfo.GradientHoverText := '#Gradient{fromColor: $FF22FF; ColorTo: $F9F3F0; percent: 100%}';
  FCellGradientDrawInfo.GradientMouseDownText := '#Gradient{fromColor: $EFE2D9; ColorTo: $00F3F0; percent: 100%}';
  FCellGradientDrawInfo.OnChange := DoDrawObjectChanged;
  FCellGradientDrawInfoEx := TGradientDrawInfo.Create;
  FCellGradientDrawInfoEx.GradientHoverText := '#Gradient{fromColor: $FF22FF; ColorTo: $F9F3F0; percent: 100%}';
  FCellGradientDrawInfoEx.GradientMouseDownText := '#Gradient{fromColor: $EFE2D9; ColorTo: $00F3F0; percent: 100%}';
  FCellGradientDrawInfoEx.OnChange := DoDrawObjectChanged;
...
procedure TxdStringGrid.SetCellGradientDrawInfoEx(const Value: TGradientDrawInfo);
begin
  FCellGradientDrawInfoEx := Value;
  Invalidate;
end;
