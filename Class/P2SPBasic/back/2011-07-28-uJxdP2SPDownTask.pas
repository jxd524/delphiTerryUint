...
begin
  ...
  dwTime := GetTickCount;
//  if dwTime - FLastExcuteTime > 10 then
//  begin
//    OutputDebugString( PChar(IntToStr(dwTime - FLastExcuteTime )) );
//  end;
          ...
          try
            ...
            begin
              ...
              begin
                ...
                if bOK then
                begin
                  if FSegmentTable.GetBlockSize(nSegIndex, nBlockIndex, nBeginPos, nBlockSize) then
                  begin
//                    OutputDebugString( PChar('请求：' + IntToStr(nBeginPos)) );
                    Inc(nRequestCount);
