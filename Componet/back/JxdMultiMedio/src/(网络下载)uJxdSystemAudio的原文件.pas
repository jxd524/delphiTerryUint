...
constructor TMixerControls.Create (AMixer:TAudioMixer; AData:TMixerLine); //4  5
...
constructor TMixerConnection.Create (AMixer:TAudioMixer; AData:TMixerLine);   //3
begin
  FData := AData;
  XMixer := AMixer;
...
constructor TMixerConnections.Create (AMixer:TAudioMixer; AData:TMixerLine); //2
var A,B:Integer;
    ML:TMixerLine;
begin
  XMixer := AMixer;
...
constructor TMixerDestination.Create (AMixer:TAudioMixer; AData:TMixerLine);  // 2
begin
  FData := AData;
  XMixer := AMixer;
...
constructor TMixerDestinations.Create (AMixer:TAudioMixer);   //   1
var A,B:Integer;
    ML:TMixerLine;
begin
