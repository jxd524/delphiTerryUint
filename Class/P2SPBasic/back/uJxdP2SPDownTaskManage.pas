...
unit uJxdP2SPDownTaskManage;

interface

uses
  Windows, SysUtils, Classes, uJxdHashCalc, WinSock2, uJxdP2SPDownTask, uJxdFileSegmentStream, uJxdUdpDefine, uJxdThread,
...
procedure TxdP2SPDownTaskManage.ActiveManage;
begin
...
{$IFNDEF ExclusionP2P}
procedure TxdP2SPDownTaskManage.AddCheckP2PSource(const Ap: PTaskManageInfo; const AUserID: Cardinal);
var
  i: Integer;
  lt: TList;
...
function TxdP2SPDownTaskManage.AddDownTask(ApDownInfo: PDownTaskParam; const AAutoStartTask: Boolean): Integer;
var
  p: PTaskManageInfo;
  i: Integer;
...
begin
  ...
  begin
    ...
    begin
      table := TxdFileSegmentTable.Create( ApDownInfo^.FFileSize, nil, ApDownInfo^.FSegmentSize );
...
{$IFNDEF ExclusionP2P}
procedure TxdP2SPDownTaskManage.AddFileServerInfo(const ATask: TxdP2SPDownTask);
var
  i, nCount: Integer;
  srv: TAryServerInfo;
begin
...
constructor TxdP2SPDownTaskManage.Create;
begin
  FCurTaskIndex := -1;
  FTaskIndexs := 0;
...
function TxdP2SPDownTaskManage.DeleteDownTask(const ATaskID: Integer): Boolean;
begin
  Result := HandleTaskOpt( ATaskID, 2 );
end;

destructor TxdP2SPDownTaskManage.Destroy;
begin
  Active := False;
  FManageList.Free;
  FDelTaskList.Free;
...
procedure TxdP2SPDownTaskManage.DoAddTask(const Ap: PTaskManageInfo);
var
  i: Integer;
  lt: TList;
  p: PTaskManageInfo;
...
procedure TxdP2SPDownTaskManage.DoCheckToDelDownTask(Ap: PTaskManageInfo);
var
  lt: TList;
  i: Integer;
begin
...
procedure TxdP2SPDownTaskManage.DoError(const AInfo: string);
begin
  OutputDebugString( PChar(AInfo) );
end;

{$IFNDEF ExclusionP2P}
procedure TxdP2SPDownTaskManage.DoHandleCmdReply_QueryFileInfo(const AIP: Cardinal; const APort: Word; const ABuffer: pAnsiChar; const ABufLen: Cardinal);
var
...
{$IFNDEF ExclusionP2P}
procedure TxdP2SPDownTaskManage.DoHandleCmdReply_FileSegmentHash(const AIP: Cardinal; const APort: Word; const ABuffer: pAnsiChar; const ABufLen: Cardinal);
var
...
{$IFNDEF ExclusionP2P}
procedure TxdP2SPDownTaskManage.DoHandleCmdReply_RequestFileData(const AIP: Cardinal; const APort: Word; const ABuffer: pAnsiChar; const ABufLen: Cardinal;
  const AIsSynchroCmd: Boolean; const ASynchroID: Word);
var
...
{$IFNDEF ExclusionP2P}
procedure TxdP2SPDownTaskManage.DoHandleCmdReply_SearchFileUser(const AIP: Cardinal; const APort: Word; const ABuffer: pAnsiChar; const ABufLen: Cardinal);
var
...
procedure TxdP2SPDownTaskManage.DoThreadCheckDownTask;
var
  lt: TList;
  p: PTaskManageInfo;
  info: TDownTaskParam;
...
function TxdP2SPDownTaskManage.FindTaskInfo(const AUrls: TArydtpHttpSourceInfo): PTaskManageInfo;
var
  i, j, nCount: Integer;
  lt: TList;
  p: PTaskManageInfo;
...
{$IFNDEF ExclusionP2P}
procedure TxdP2SPDownTaskManage.FreeThreadList(const Ap: PTaskManageInfo);
var
  i: Integer;
  lt: TList;
begin
...
function TxdP2SPDownTaskManage.FindTaskInfo(const AHashStyle: THashStyle; const AFileHash: TxdHash): PTaskManageInfo;
var
  i: Integer;
  lt: TList;
  p: PTaskManageInfo;
...
function TxdP2SPDownTaskManage.GetDownTaskFileStream(const ATaskID: Integer): Integer;
var
  i: Integer;
  lt: TList;
  p: PTaskManageInfo;
...
function TxdP2SPDownTaskManage.GetDownTaskProgressInfo(Ap: PDownTaskProgressInfo): Boolean;
var
  i, j: Integer;
  lt: TList;
  p: PTaskManageInfo;
...
function TxdP2SPDownTaskManage.GetTaskCount: Integer;
begin
  Result := FManageList.LockList.Count;
  FManageList.UnlockList;
end;

function TxdP2SPDownTaskManage.HandleTaskOpt(const ATaskID: Integer; const AOptSign: Integer): Boolean;
var
  i: Integer;
  lt: TList;
  p: PTaskManageInfo;
...
procedure TxdP2SPDownTaskManage.LoadFromFile;
var
  ...
  nAryFinisheds: TAryFileFinishedInfos;
...
procedure TxdP2SPDownTaskManage.OnlyStartTheTask(const ATaskID: Integer);
var
  i: Integer;
  lt: TList;
  p: PTaskManageInfo;
...
{$IFNDEF ExclusionP2P}
procedure TxdP2SPDownTaskManage.QueryHashServer(const Ap: PTaskManageInfo);
var
  dwTime: Cardinal;
  i, nCount: Integer;
...
procedure TxdP2SPDownTaskManage.ReleaseFindInfo(const Ap: PTaskManageInfo);
begin
  if Assigned(Ap) then
    InterlockedDecrement( Ap^.FCount );
end;

procedure TxdP2SPDownTaskManage.SaveToFile;
var
  i, j: Integer;
...
procedure TxdP2SPDownTaskManage.SetActive(const Value: Boolean);
begin
...
procedure TxdP2SPDownTaskManage.SetFileName(const Value: string);
var
  strDir: string;
begin
...
function TxdP2SPDownTaskManage.StartDownTask(const ATaskID: Integer): Boolean;
begin
  Result := HandleTaskOpt( ATaskID, 1 );
end;

function TxdP2SPDownTaskManage.StopDownTask(const ATaskID: Integer): Boolean;
begin
  Result := HandleTaskOpt( ATaskID, 0 );
end;

function TxdP2SPDownTaskManage.TaskIndexToID(const AIndex: Integer; var ATaskID: Integer): Boolean;
var
  lt: TList;
  p: PTaskManageInfo;
begin
...
function TxdP2SPDownTaskManage.TestDown: Integer;
var
...
procedure TxdP2SPDownTaskManage.UnActiveManage;
var
  i: Integer;
  lt: TList;
  p: PTaskManageInfo;
