...
begin
  ...
  try
    ...
    pUnk.QueryInterface( IID_IMediaEventEx, FMediaEventEx );
    pUnk.QueryInterface( IID_IMediaSeeking, FMediaSeek );

    FMediaEventEx.SetNotifyFlags(0);
    FMediaEventEx.SetNotifyWindow(Handle, WM_GRAPHNOTIFY, 0);
...
begin
  ...
  begin
    ...
    Param1:= 0;
    Param2:= 0;
    while FMediaEventEx.GetEvent(EventCode,Param1,Param2,0) = S_OK do
    begin
...
//        EC_USERABORT: DoError(0, 'EC_USERABORT');
//        EC_ERRORABORT: DoError(0, 'EC_ERRORABORT');
      end;
    end;
  end;
end;
