...
procedure TxdLyricParse.ClearAllValue;
var
  i: Integer;
begin
  FTimeOffset := 0;
...
constructor TxdLyricParse.Create;
begin
  FLyricList := TList.Create;
  ClearAllValue;
end;

destructor TxdLyricParse.Destroy;
begin
  ClearAllValue;
  FLyricList.Free;
  inherited;
...
function TxdLyricParse.GetLineInfo(ATime: Integer;
...
function TxdLyricParse.GetLineString(ALine: string): string;
var
  i, nLen: Integer;
begin
  nLen := 0;
...
function TxdLyricParse.GetLyricLineString(AIndex: Integer;
...
procedure TxdLyricParse.GetLyricMsg(AStrList: TStringList);
var
  i: Integer;
  p: PLine;
begin
...
function TxdLyricParse.GetLineInfoByIndex(AIndex: Integer;
  var ALineInfo: TLineInfo): Boolean;
begin
  Result := False;
...
procedure TxdLyricParse.GetSemicolon(const AText: string; var AForwardSign,
  ABackSign: string);
var
  pos1: Integer;
begin
...
function TxdLyricParse.GetSquareBracketsMsg(var AText, Content: string): Boolean;
var
  pos1, pos2: Integer;
begin
  pos1 := Pos('[', AText);
...
function TxdLyricParse.JudgeIsInteger(AText: string): Boolean;
begin
  try
    StrToInt(AText);
    Result := True;
...
function TxdLyricParse.LoadLyricFile(ALyricName: string): Boolean;
var
  nTime: Integer;
...
procedure TxdLyricParse.SaveLyricFile;
var
  FileList: TStrings;
begin
...
procedure TxdLyricParse.SetTimeOffset(const Value: Integer);
begin
...
function TxdLyricParse.TimeToStr(ATime: Integer): string;
var
  LeftStr, RightStr: string;
begin
