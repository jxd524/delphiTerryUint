...
type
  ...
  TSegmentInfo = record
    ...
    FSegmentBeginPos: Int64;
    FSegmentSize: Cardinal;
    FSegmentState: TSegmentState;
    FSegmentActiveTime: Cardinal;
    FBlockCount: Integer;
    FRecvBlockCount: Integer;
    FBlockState: array[0..0] of TBlockState;
  end;
  ...
  {一个只读内存映射文件的内存读操作，以适合多线程操作而不需要锁定}
...
const
  ...
  CtBlockSize = //CtSinglePackageSize - CtCmdReplyRequestFileInfoSize; //最大单包中的数据长度
                CtMaxCombiPackageSize - CtCmdReplyRequestFileInfoSize; //最大可发送组合包中的数据长度
