...
interface
uses
  Windows, Classes, SysUtils, ExtCtrls, WinSock2, uQueues, uCode;
...
type
  ...
  private
    ...
    FRecordSize: Integer;
    FMemoryManage: TStaticMemoryManager;
...
begin
  ...
  FMemoryManage := TStaticMemoryManager.Create( FRecordSize, AMaxSocketCount );
...
begin
  ...
  FMemoryManage := TStaticMemoryManager.Create( FRecordSize, AMaxBufferCount );
